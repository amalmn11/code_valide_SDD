...
double lire_reel(char *caractere)
{
    ...
    // Modification ici pour prendre en compte le caractère de fin de ligne
...
void lire_Expression_arith()
{
	...
	do
    {
        ...
        {
            break;  // Sortir si le caractère est un retour à la ligne
        }
        else
        {
