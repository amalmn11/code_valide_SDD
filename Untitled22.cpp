...
void inserer_Exp_Arb(Noeud *ptarbcrt, double val, char car);
...
//void inserer_Exp_Arb(Noeud *Arb, double val, char car)
//{
//    Noeud *Nop = creer_noeud();
//    Noeud *Nval = creer_noeud();
//    Nop->info.caractere = car;
...
//    {
////        crt = Arb;
//        if((crt->info.caractere == '+') || (crt->info.caractere == '-' ))
//        {
//            Nop->fgch = Nval;
//            crt->fdrt = Nop;
//            crt=Nop;
